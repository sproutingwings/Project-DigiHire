            ...
            <form role="form" method="post">
              ...
              <div class="box-body">
                ...
                <div class="row form-group">
                    <div class="col-xs-6">
                    <input type="text" class="form-control" name="adhaar_no" placeholder="Addhaar Number" id="adhaar_no">
                    </div>
                    <div class="col-xs-6">
                    <input type="text" class="form-control" placeholder="Username" autocomplete="username" name="username" id="username">
                    </div>
                </div>
                <div class="row form-group">
                    <div class="col-xs-6">
                ...
                <div class="row form-group">
                    <div class="col-xs-6">
                    <input type="email" class="form-control" name="email" autocomplete="email" placeholder="Email" id="email">
                    </div>
                </div>
                <div class="row form-group">
                    <div class="col-xs-6">
                    <input type="password" class="form-control" name="password" autocomplete="new-password" placeholder="Password" id="password">
                    </div>
                </div>
                <div class="row form-group">
                    <div class="col-xs-6">
                    <input type="password" class="form-control" name="confpassword" autocomplete="new-password" id="confpassword" placeholder="Confirm Password">
                    </div>
                    <div class="col-xs-6">
                ...
                <div class="checkbox">
                  <label>
                    <input type="checkbox" id="terms"> By signing up you agree to our <a href="#">terms and conditions</a>.  
                    <br />  
